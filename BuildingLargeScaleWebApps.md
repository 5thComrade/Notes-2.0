...
A solid folder structure allows developers to add new code without thinking too much about the best place to put it. More importantly, it enables developers to add new features while keeping a consistent and organized code structure throughout the project’s life cycle.
...
- **public/**
  ...
  Contains all the static files that our app might need but doesn’t necessarily go through the build process (i.e., the process of minification, transpilation, andbundling, which transform development code into optimized, production-ready files).
